      ...
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px]">
        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <div className="mt-4 border-t pt-4 text-sm text-gray-700">
            ...
            <p><strong>Phone:</strong> {orderInfo.customerPhone}</p>
            <p><strong>Guests:</strong> {orderInfo.customerGuests}</p>
          </div>
          ...
          <div className="mt-4 border-t pt-4 text-sm">
            <p><strong>Subtotal:</strong> Rs{orderInfo.billTotal.toFixed(2)}</p>
            <p><strong>Tax:</strong> Rs{orderInfo.billTax.toFixed(2)}</p>
            <p className="text-md font-semibold">
              <strong>Grand Total:</strong> Rs{orderInfo.billTotalWithTax.toFixed(2)}
            </p>
          </div>
          ...
          <div className="mb-2 mt-2 text-xs">
            ...
            {orderInfo.paymentMethod === "Online" && (
              <>
                <p><strong>Razorpay Order ID:</strong> {orderInfo.razorpayOrderId}</p>
                <p><strong>Razorpay Payment ID:</strong> {orderInfo.razorpayPaymentId}</p>
              </>
            )}
          </div>
        </div>
